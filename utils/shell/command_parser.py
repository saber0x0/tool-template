...
from utils.core.dynamic_load import load_module
from utils.core.exception import exception
from utils.core.print import print_info, print_error, print_ok
from .banner import banner
from utils.core.glb_list import Global
from utils.core.help import show_help
from utils.core.find import Find
from utils.core.tasks import Task
...
class CommandParser:
    def __init__(self):
        self.module = None
        self.module_commands = ["set", "unset", "back", "show", "run", "global", "fuzz"]
        self.commands = {
            "load": self._load,
            "help": self._help,
            "banner": self._banner,
    ...
    def _setglobal(self, user_input=None):
    ...
    def _fuzz(self, params):
        if "can" in params:
            print("fuzz can op is ok")
        elif "doip" in params and len(params) >= 2:
            print("fuzz doip op is ok")

class CommandPalette(object):
    ...
    def __init__(self, primary="ansibrightblue", confirm="ansigreen", accent="ansiyellow", warn="ansired",
                 text="ansiblack", text_secondary="ansibrightblack", banner="ansired"):
...
colors_terminal = {
    ...
    "light": CommandPalette(primary="ansibrightblue", confirm="ansigreen", accent="ansiyellow", warn="ansired",
                            text="ansiblack", text_secondary="ansibrightblack", banner="ansired"),
    "dark": CommandPalette(primary="cyan", confirm="ansibrightgreen", accent="ansibrightyellow", warn="ansibrightred",
                           text="ansiwhite", text_secondary="ansigray", banner="magenta"),
    "ddd": CommandPalette(primary="cyan", confirm="ansibrightblack", accent="ansired", warn="ansiyellow",
                          text="ansiwhite", text_secondary="ansigreen", banner="magenta"),
    # set theme by yourself
}

...
class RHOST(GenericOption):
    def __init__(self, value=None, required=False, description="Remote host IP",
                 match_pattern=r"^\d{_1,3}\.\d{_1,3}\.\d{_1,3}\.\d{_1,3}$|^\d{_1,3}\.\d{_1,3}\.\d{_1,3}\.\d{_1,3}\\\d+$"):
        key = "rhost"
...
class Channel(GenericOption):
    def __init__(self, value=None, required=False,
                 description="Network channel. Configure this option if you want to fix it and not 'make jumps'",
                 match_pattern=r"^\d{_1,2}$"):
        key = "channel"
...
class Fofa(GenericOption):
    def __init__(self, value=None, required=False, description="Fofa API Key"):
        key = "fofa"
        super(Fofa, self).__init__(key, value, required, description)

class Openaikey(GenericOption):
    def __init__(self, value=None, required=False, description="Openai API Key"):
        key = "openai"
        super(Openaikey, self).__init__(key, value, required, description)